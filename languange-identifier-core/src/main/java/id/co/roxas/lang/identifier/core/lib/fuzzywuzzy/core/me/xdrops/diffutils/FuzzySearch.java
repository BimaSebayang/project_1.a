...
import id.co.roxas.lang.identifier.core.lib.fuzzywuzzy.core.me.xdrops.diffutils.algorithms.TokenSet;
import id.co.roxas.lang.identifier.core.lib.fuzzywuzzy.core.me.xdrops.diffutils.algorithms.TokenSort;
import id.co.roxas.lang.identifier.core.lib.fuzzywuzzy.core.me.xdrops.diffutils.algorithms.WeightedRatio;
...
import id.co.roxas.lang.identifier.core.lib.fuzzywuzzy.core.me.xdrops.diffutils.ratios.PartialRatio;
...
public class FuzzySearch {
	...
	/**
	 * Calculates a Levenshtein simple ratio between the strings. This is indicates
	 ...
	 * @param s1             Input string
	 * @param s2             Input string
	 * @param stringFunction Functor which transforms strings before calculating the
	 *                       ratio
	 * @return The simple ratio
	 */
	...
	/**
	 * Inconsistent substrings lead to problems in matching. This ratio uses a
	 * heuristic called "best partial" for when two strings are of noticeably
	 * different lengths.
	 *
	 * @param s1 Input string
	 * @param s2 Input string
	...
	/**
	 * Find all alphanumeric tokens in the string and sort those tokens and then
	 * take ratio of resulting joined strings.
	 *
	 * @param s1 Input string
	 * @param s2 Input string
	 ...
	 * between the tokens of the two strings. A comparison string is then built up
	 * and is compared using the simple ratio algorithm. Useful for strings where
	 * words appear redundantly.
	 *
	 * @param s1 Input string
	 * @param s2 Input string
	 ...
	 * @return A list of the results
	 */
	public static List<ExtractedResult> extractTop(String query, Collection<String> choices, Applicable func,
			int limit) {
	...
	/**
	 * Creates a <b>sorted</b> list of {@link ExtractedResult} which contain all the
	 * choices with their corresponding score where higher is more similar
	 *
	 * @param query   The query string
	 * @param choices A list of choices
	 * @param func    The scoring function
	...
	public static List<ExtractedResult> extractSortedMap(String query,Map<String,String> choices) {
		Extractor extractor = new Extractor();
	...
	public static <T> List<BoundExtractedResult<T>> extractTop(String query, Collection<T> choices,
			ToStringFunction<T> toStringFunction, Applicable func, int limit, int cutoff) {
	 ...
	 */
	public static <T> List<BoundExtractedResult<T>> extractSorted(String query, Collection<T> choices,
			ToStringFunction<T> toStringFunction, Applicable func, int cutoff) {
